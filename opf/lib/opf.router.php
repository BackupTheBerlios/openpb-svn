<?php
  ...
  //  --------------------------------------------------------------------  //
	...
	define('OPF_ROUTER_DEFAULT', 'default');
	define('OPF_ROUTER_NICE', 'nice');
	define('OPF_ROUTER_VALUE', 'value');
    ...
    class opfValueRouter implements iopfRouter
    {
        private $dataBuffer;
        private $i = 0;
        private $page;
