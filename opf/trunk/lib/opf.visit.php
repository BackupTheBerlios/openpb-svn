<?php
  ...
  //  --------------------------------------------------------------------  //
	...
	class opfVisit
	{
		...
		public function __construct()
		{
			...
			switch(true)
			{
				...
				case (strpos($_SERVER['SERVER_PROTOCOL'], 'WAP') !== FALSE):
					$this -> currentPath = $this -> currentAddress = $this -> currentFile = 'wap://';
					break;
			}
			...
			{
				$this -> detectLanguage($_SERVER['HTTP_ACCEPT_LANGUAGE']);			
			}
			else
			{
		...
		private function detectLanguage($lang)
		{
			if(is_null($lang))
			{
